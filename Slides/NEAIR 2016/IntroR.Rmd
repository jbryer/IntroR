...
subtitle: "North East Association for Institutional Research"
...
>-  Easily extensible with `r nrow(available.packages('https://cran.r-project.org'))` packages listed on CRAN (as of `r format(Sys.Date(), '%B %d, %Y')`).
>-  Scriptable.
...
* 2015: Current version of R is `r paste(R.version$major, R.version$minor, sep='.')`
* There are `r nrow(available.packages('https://cran.r-project.org'))` packages listed on CRAN. 
